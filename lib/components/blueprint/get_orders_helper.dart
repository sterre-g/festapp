...
class GetOrdersHelper {
  static List<BlueprintGroupModel> parseGroups(Map<String, dynamic> json) {
    return json[TbEshop.blueprints.groups] != null ? List<BlueprintGroupModel>.from(json[TbEshop.blueprints.groups].map((g) => BlueprintGroupModel.fromJson(g))) : [];
  }

  static List<BlueprintObjectModel>? parseObjects(Map<String, dynamic> json) {
    return json[TbEshop.blueprints.objects] != null ? List<BlueprintObjectModel>.from(json[TbEshop.blueprints.objects].map((obj) => BlueprintObjectModel.fromJson(obj))) : null;
  }

  static List<BlueprintObjectModel>? parseSpots(Map<String, dynamic> json) {
    return json[BlueprintModel.metaSpots] != null ? List<BlueprintObjectModel>.from(json[BlueprintModel.metaSpots].map((spot) => BlueprintObjectModel.fromJson(spot))) : null;
  }

  static List<ProductModel>? parseProducts(Map<String, dynamic> json) {
    return json[TbEshop.products.table] != null ? List<ProductModel>.from(json[TbEshop.products.table].map((p) => ProductModel.fromJson(p))) : null;
  }

  static List<ProductTypeModel>? parseProductTypes(Map<String, dynamic> json) {
    return json[TbEshop.product_types.table] != null ? List<ProductTypeModel>.from(json[TbEshop.product_types.table].map((pt) => ProductTypeModel.fromJson(pt))) : null;
  }

  static List<TicketModel>? parseTickets(Map<String, dynamic> json) {
    return json[TbEshop.tickets.table] != null ? List<TicketModel>.from(json[TbEshop.tickets.table].map((t) => TicketModel.fromJson(t))) : null;
  }

  static List<OrderModel>? parseOrders(Map<String, dynamic> json) {
    return json[TbEshop.orders.table] != null ? List<OrderModel>.from(json[TbEshop.orders.table].map((o) => OrderModel.fromJson(o))) : null;
  }

  static List<OrderProductTicketModel>? parseOrderProductTickets(Map<String, dynamic> json) {
    return json[TbEshop.order_product_ticket.table] != null ? List<OrderProductTicketModel>.from(json[TbEshop.order_product_ticket.table].map((o) => OrderProductTicketModel.fromJson(o))) : null;
  }

  static List<PaymentInfoModel>? parsePaymentInfo(Map<String, dynamic> json) {
    return json[TbEshop.payment_info.table] != null ? List<PaymentInfoModel>.from(json[TbEshop.payment_info.table].map((g) => PaymentInfoModel.fromJson(g))) : [];
  }

  static List<FormModel>? parseForms(Map<String, dynamic> json) {
    return json[Tb.forms.table] != null ? List<FormModel>.from(json[Tb.forms.table].map((g) => FormModel.fromJson(g))) : [];
  }
  ...
  static List<BlueprintObjectModel>? enrichObjects(
    ...
    return rawObjects
        .map((object) {
          if (object.type == BlueprintModel.metaSpotType) {
            ...
            return BlueprintObjectModel(
              ...
              stateEnum: BlueprintObjectModel.statesMap.entries.firstWhereOrNull((entry) => entry.value == matchingSpot?.state)?.key ?? SeatState.available,
              x: object.x,
              y: object.y,
            );
        ...
        .whereType<BlueprintObjectModel>()
