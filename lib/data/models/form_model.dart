import 'package:fstapp/data/models/eshop/bank_account_model.dart';
...
class FormModel {
  ...
  factory FormModel.fromJson(Map<String, dynamic> json) {
    return FormModel(
      id: json[Tb.forms.id],
      createdAt: json[Tb.forms.created_at] != null ? DateTime.parse(json[Tb.forms.created_at]) : null,
      ...
      bankAccount: json[Tb.forms.bank_account] != null ? BankAccountModel.fromJson(json[Tb.forms.bank_account]) : null,
      ...
      relatedFields: json['fields'] != null ? (json['fields'] as List).map((field) => FormFieldModel.fromJson(field)).toList() : null,
      availableBankAccounts: json['available_bank_accounts'] != null ? (json['available_bank_accounts'] as List).map((account) => BankAccountModel.fromJson(account)).toList() : null,
    );
  }
  ...
  List<String> getSupportedCurrencies() {
    ...
    if (bankAccount != null && bankAccount!.supportedCurrencies != null && bankAccount!.supportedCurrencies!.isNotEmpty) {
