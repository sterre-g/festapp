...
class BankAccountModel {
  ...
  factory BankAccountModel.fromJson(Map<String, dynamic> json) {
    return BankAccountModel(
      ...
      createdAt: json[TbEshop.bank_accounts.created_at] != null ? DateTime.parse(json[TbEshop.bank_accounts.created_at]) : null,
      ...
      lastFetchTime: json[TbEshop.bank_accounts.last_fetch_time] != null ? DateTime.parse(json[TbEshop.bank_accounts.last_fetch_time]) : null,
      isFetchEnabled: json[TbEshop.bank_accounts.is_fetch_enabled],
      supportedCurrencies: json[TbEshop.bank_accounts.supported_currencies] != null ? List<String>.from(json[TbEshop.bank_accounts.supported_currencies]) : null,
    );
  }
