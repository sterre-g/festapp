...
class FormFieldModel extends ITrinaRowModel {
  ...
  factory FormFieldModel.fromJson(Map<String, dynamic> json) {
    ...
    return FormFieldModel(
        ...
        createdAt: json[Tb.form_fields.created_at] != null ? DateTime.parse(json[Tb.form_fields.created_at]) : null,
        ...
        productType: json[Tb.form_fields.product_type_data] != null ? ProductTypeModel.fromJson(json[Tb.form_fields.product_type_data]) : null,
        options: options);
  }
  ...
  TrinaRow toTrinaRow(BuildContext context) {
    return TrinaRow(cells: {
      ...
      Tb.form_fields.created_at: TrinaCell(value: createdAt != null ? DateFormat('yyyy-MM-dd').format(createdAt!) : ""),
