...
class ExclusiveGroupModel extends ITrinaRowModel {
  ...
  static ExclusiveGroupModel fromPlutoJson(Map<String, dynamic> json) {
    ...
    return ExclusiveGroupModel(id: json[Tb.exclusive_groups.id] == -1 ? null : json[Tb.exclusive_groups.id], title: json[Tb.exclusive_groups.title], events: events);
  }

  @override
  TrinaRow toTrinaRow(BuildContext context) {
    return TrinaRow(
        cells: {Tb.exclusive_groups.id: TrinaCell(value: id), Tb.exclusive_groups.title: TrinaCell(value: title), Tb.events.table: TrinaCell(value: events?.map((e) => e.toString()).join(",") ?? "")});
  }
